package kr.co.poscoict.card.common.handler;
...
import kr.co.poscoict.card.common.except.ResourceConflictException;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 * @return
	 */
	@ExceptionHandler(value = CardBusinessException.class)
	protected ResponseEntity<Object> handleBusinessError(CardBusinessException e, WebRequest request) {
		logger.error(e.getMessage(), e);
		return super.handleExceptionInternal(e,
				new ErrorResponse(StringUtils.isNotEmpty(e.getMessage()) ? e.getMessage() : messageSource.getMessage("api.error.serverError")),
				new HttpHeaders(), HttpStatus.BAD_REQUEST, request);
