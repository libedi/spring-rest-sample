...
public class RmsChrgRcptAcc {
	...
	public String toString() {
		return "RmsChrgRcptAcc [idx=" + idx + ", payrSeq=" + payrSeq + ", commcClf=" + commcClf + ", commcClfNm="
				+ commcClfNm + ", mphnNo=" + mphnNo + ", billAmt=" + billAmt + ", rcptAmt=" + rcptAmt + ", npayAmt="
				+ npayAmt + "]";
	}
}
